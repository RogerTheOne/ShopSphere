    ...
    <div class="container">
      <ul>
        <template v-if="userStore.userInfo?.token">
          <li><a href="javascript:;"><i class="iconfont icon-user"></i>Roger Zhang</a></li>
          <li>
            <el-popconfirm @confirm="confirm" title="Wanna go?" confirm-button-text="Yes" cancel-button-text="No">
              <template #reference>
